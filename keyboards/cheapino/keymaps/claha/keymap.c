...
#define THUMB_L2 LT(SYM, KC_TAB)
#define THUMB_L1 LT(NAV, KC_SPC)
#define THUMB_L0 KC_NO
#define THUMB_R0 KC_NO
#define THUMB_R1 LT(FUN, KC_ENT)
#define THUMB_R2 LT(NUM, KC_BSPC)
...
const uint16_t PROGMEM combo_syslayer[] = {THUMB_R1, THUMB_R2, COMBO_END};
combo_t key_combos[] = {
